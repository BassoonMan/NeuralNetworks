...
class Word2Vec:
    ...
    def writeEmbeddings(self): # Output the embedding matrix into a file so I can use them elsewhere
        self.net.outputEmbedding()
    
    def writeWords(self): # Output the word list in correct order into a file so I can use them elsewhere
